...
## [0.2.1](https://github.com/Aetf/hackrf-proxy/compare/v0.2.0...v0.2.1) - 2026-09-14

### Other

- update Cargo.lock dependencies

## [0.2.0](https://github.com/Aetf/hackrf-proxy/compare/v0.1.1...v0.2.0) - 2026-09-12

### Fixed

- [**breaking**] send repeats back-to-back unless a gap is asked for
